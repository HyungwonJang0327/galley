...
- [x] 🔒 B2c — 실행 상세 2분할 화면(사용자 작성 + 리뷰 14건 반영) (2026-09-14, PR #92)
...
- ~~P4-11~~ — 완료(2026-09-21, refactor/dashboard-use-confirm, todo/mvp-todo.md P4-11). RunActionBar 확인 Dialog 2개(재실행·승인)를 `useConfirm`으로 치환. P4-9 머지 뒤, P5 앞. 브랜치 `refactor/dashboard-use-confirm`. 착수 전 todo/mvp-todo.md P4-11의 "P4-9 리뷰 L7 입력"(size sm·pending 동안 열어둠·재실행 children) 읽기.
