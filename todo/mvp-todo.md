...
- [x] **BE6** (2026-09-22 `c077fc5`·`0f31b7e`·리뷰 수정 `4e6bdcc`·`09437bc`·decisions `e01cda6`·`c0170e1`, feat/queue-hint-parser — 파일 파서 불변, 추출은 적재 경계, 기간은 정규형 `YYYY-MM`) pl — `주제_큐.md` 괄호 힌트 파서 확장(리포 이름·alias·키워드·기간 추출, 괄호 형식 불변) + 테스트. ~~주제 슬러그 파생~~ → **B1e에서 이미 구현**(`topicSlug()`, 2026-09-12 `01c721c`). 커밋: `feat(queue): 주제 항목에서 리포·키워드·기간 추출`
