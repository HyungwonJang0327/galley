...
- [x] **P4-2** (2026-09-17 `5c96198`·갤러리 `355d0ac`·리뷰 5커밋 `63a7739`–`543bd34`, feat/ui-switch) ui — **Switch**(primitives, Base UI Switch) — 제어형 `checked`/`onCheckedChange` · `children` 라벨(없으면 `aria-label` 필수) · `disabled` · `name`. Checkbox와 같은 label 감싸기. 브랜치 `feat/ui-switch`. 커밋: `feat(ui): Switch 프리미티브 추가`
