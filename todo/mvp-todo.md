...
- [x] **BS4** (2026-09-23 헬퍼 이동 `4da3eb0`·상한 `54a00c1`·단계 `433702f`·배럴 `d46864a`·decisions `9767e70`, feat/zenn-step — frontmatter는 코드, `published: false` 상수, H1→title, topics 비움) pl — Zenn 일본어판 단계(`zenn`): 입력 = 벨로그 본문 + 어투 프롬프트 → `artifacts.zenn`(frontmatter `published: false` 고정, title·emoji·type·topics). 커밋: `feat(run): Zenn 일본어판 단계 구현`
