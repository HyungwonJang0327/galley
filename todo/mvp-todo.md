...
- [x] **BE13** (2026-09-27 `352440d`·`52df72a`·`e82fc30`·`a857963` + 리뷰 `8e2b57c`·`eb1658c`·`e120366`, feat/timeline-evidence-verify) fe — 실행 상세 타임라인에 근거 수집("연결 n · 탐색 n", 펼침 항목 목록·조각 3줄)·근거 검증("근거 없음 n · 불확실 n" 주황 배지, 펼침 주장 목록·판정 사유·근거 위치) 표시 + 좌 목록 "근거 없음 n". 홈 "지금 할 일"은 **AH5에서**(카드 미구현). 커밋: `feat(dashboard): 타임라인에 근거·검증 결과 표시`
