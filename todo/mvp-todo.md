...
- [x] **실측 Chrome 기동 대기 30초**(사용자 결정, fix/dashboard-chrome-wait): CI `layout`이 `timeout: DevToolsActivePort`로 2회 실패(PR #55·#57) → `cdp.mjs` DevToolsActivePort 대기 15→30초 (2026-09-12 `d269bc0`). decisions/layout-measurement.md 갱신 이력.
