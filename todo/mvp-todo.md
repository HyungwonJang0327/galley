...
- [x] **P4-3** (2026-09-17 `fc85718`·갤러리 `0b9e0f0`·리뷰 9커밋 `7fbb8b0`–`d76747e`, feat/ui-radio-group) ui — **RadioGroup**(primitives, Base UI Radio/RadioGroup) — 제어형 `value`/`onValueChange` · `items: {value,label,description?,disabled?}[]` · `aria-label` · `orientation`. 아이템 레이아웃은 ItemContent 재사용. 브랜치 `feat/ui-radio-group`. 커밋: `feat(ui): RadioGroup 프리미티브 추가`
