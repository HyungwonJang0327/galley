...
INSERT INTO "new_RunStep" ("costUsd", "createdAt", "durationMs", "finishedAt", "id", "inputTokens", "modelId", "name", "order", "origin", "outputTokens", "runId", "sourceRunId", "startedAt", "status", "updatedAt") SELECT "costUsd", "createdAt", "durationMs", "finishedAt", "id", "inputTokens", "modelId", "name", "order", "origin", "outputTokens", "runId", "sourceRunId", "startedAt", "status", "updatedAt" FROM "RunStep";
DROP TABLE "RunStep";
